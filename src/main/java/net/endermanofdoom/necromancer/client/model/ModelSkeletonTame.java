package net.endermanofdoom.necromancer.client.model;
...
public class ModelSkeletonTame extends ModelBiped
{
    public ModelSkeletonTame()
    {
        this(0.0F, false);
    }

    public ModelSkeletonTame(float modelSize, boolean p_i46303_2_)
    {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime)
    {
        ...
        if (itemstack.getItem() instanceof net.minecraft.item.ItemBow && ((EntitySkeletonTame)entitylivingbaseIn).isSwingingArms())
        {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        EntitySkeletonTame abstractskeleton = (EntitySkeletonTame)entityIn;
